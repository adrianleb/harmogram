...
(function() {
  ...
  Renderer = (function() {
    ...
    Renderer.prototype.initPoints = function() {
      var i, j, point, ref, ref1, results, x, y;
      this.log = 0;
      results = [];
      for (i = j = 0, ref = this.BARS, ref1 = this.gapper; ref1 > 0 ? j < ref : j > ref; i = j += ref1) {
        ...
        results.push(this.path.add(point));
      }
      return results;
    };
    ...
    Renderer.prototype.shader = function(value) {
      var dot, i, j, magnitude, p, ref, ref1, x, y;
